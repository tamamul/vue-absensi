<template>
  <div class="super-z fixed top-0 left-0 right-0">
    ...
    >
      <a
        href="#"
        class="cursor-pointer underline md:text-base sm:text-sm text-xs"
        >celebesdigital@gmail.com</a
      >
      <br />

      <a
        href="https://api.whatsapp.com/send/?phone=6282292877750&text&type=phone_number&app_absent=0"
        class="cursor-pointer md:text-base sm:text-sm text-xs"
        >Hubungi kami +62 822-9287-7750</a
      >
    </div>

    <nav class="bg-white border-gray-200 border-b border-b-slate-300">
      <div
        class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4 px-10 md:px-14"
      >
        <a href="" class="flex items-center rtl:space-x-reverse">
          <img
            src="/public/asset/LOGO-ABSENKI.png"
            class="sm:h-6 h-4"
            alt="Absensi Logo"
          />
        ...
        <div class="flex">
          ...
          <RouterLink to="/login" class="md:hidden block">
            <Button
              label="Log In"
              class="sm:px-8 px-6 sm:text-base text-xs hover:bg-white border-2 hover:text-blue-500 bg-blue-500"
            ></Button>
          </RouterLink>
          ...
          >
            <li class="my-auto">
              <a
                ...
                class="cursor-pointer block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-500 md:p-0 transition-all"
                >Tentang Kami</a
              >
            </li>
            <li class="my-auto">
  ...
  <div class="card top-0">
    ...
    >
      <a
        @click="scrollTo('about')"
        class="text-surface-500 dark:text-surface-400 block mb-8 cursor-pointer font-semibold hover:text-blue-500 transition-all"
        >Tentang Kami</a
      >
      <a
        @click="scrollTo('fitur')"
